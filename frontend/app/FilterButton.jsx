...
class FilterButton extends React.Component {
    ...
    componentWillReceiveProps(newProps){
        if(newProps.hasOwnProperty("isActive")) this.setState({active: newProps.isActive});
    }
    ...
    filterIconClicked(event) {
        console.log("filterIconClicked: " + this.state.active);
    ...
    className() {
        if(this.state.active) {
            return "fa fa-remove control-icon"
        } else {
